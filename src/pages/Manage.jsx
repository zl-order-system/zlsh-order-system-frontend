...
function Items({itemsData}){
    ...
    let handleSelectChange = (event,index) => {
        let newSelectedValue = [...selectedValue]
        newSelectedValue[index] = event.target.value
            ...
            <div className=" flex flex-col w-full my-[0.75rem]" key={index}>
                ...
                <div className={`flex flex-row justify-between items-center`}>
                    ...
                    <div className={`${element["css"]["displayOfSelectBlock"]} flex flex-row gap-2 mt-[2px]`}>
                        <select defaultValue={element["lunchBox"]} className="py-0.5 px-1 h-fit text-[0.9rem] text-[#6C6C6C] font-[300] rounded-[0.25rem] border-[1px] border-[#ACACAC] leading-[100%] bg-white">
                            <option value="自備餐盒">自備餐盒</option>
                            <option value="學校餐盒">學校餐盒</option>
                        </select>
                        <select defaultValue={element["mealNumber"]} onChange={(event)=>{handleSelectChange(event,index)}} className="py-0.5 px-1 text-[0.9rem] text-[#6C6C6C] font-[300] rounded-[0.25rem] border-[1px] border-[#ACACAC] leading-[100%] bg-white">
                            {   
