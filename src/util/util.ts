...
export const redirectToMainApp = (win: Window) => win.location = getAppConstants().MAIN_APP_URL

export const redirectToLoginPage = (win: Window) => win.location = `${getAppConstants().MAIN_APP_URL}#/login`
